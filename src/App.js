  ...
  return (
    <div ref={appRef} className="App">
      <Routes>
        ...
        <Route
          exact
          path="/event-types/mouse-events/click"
          element={
            <>
        ...
        <Route
          exact
          path="/event-types/mouse-events/move"
          element={
            <>
              {" "}
        ...
        <Route
          exact
          path="/event-listeners/add-event-listeners"
          element={
            <>
              {" "}
        ...
        <Route
          exact
          path="/event-listeners/add-event-listeners-example"
          element={
            <>
              {" "}
        ...
        ></Route>
        <Route
          path="/event-listeners/remove-event-listener"
          element={
            <>
              {" "}
        ...
        <Route
          exact
          path="/event-listeners/remove-event-listeners-example"
          element={
            <>
              {" "}
        ...
        ></Route>
        <Route
          path="/anonymous-functions-continue"
          element={
            <>
              {" "}
        ...
        ></Route>
        <Route
          path="/arguments.callee-continue"
          element={
            <>
              {" "}
        ...
        <Route
          exact
          path="/about"
          element={<AboutPage setIsFirstRound={setIsFirstRound} />}
        ></Route>
      </Routes>
    </div>
  );
